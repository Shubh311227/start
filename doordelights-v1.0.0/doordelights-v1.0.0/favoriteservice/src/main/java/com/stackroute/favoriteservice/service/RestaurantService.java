...
public interface RestaurantService {
    Favourite addToFavourites(Favourite favourite) throws FavouriteAlreadyExistsException;
    Favourite removeFromFavourites(String emailid, String id) throws FavouriteListDoesNotExistsException;
    List<Restaurant> getFavouriteRestaurant(String emailid) throws FavouriteListDoesNotExistsException;
}
